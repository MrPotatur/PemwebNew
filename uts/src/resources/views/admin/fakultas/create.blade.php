    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fakultass.store") }}" encnim="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fakultasname') ? 'is-invalid' : '' }}" nim="text" name="fakultasname" id="fakultasname" value="{{ old('fakultasname', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" nim="text" name="nama" id="nama" value="{{ old('nama', '') }}" required>
                @if($errors->has('nama'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nama') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nim') ? 'is-invalid' : '' }}" nim="text" name="nim" id="nim" value="{{ old('nim', '') }}" required>
                @if($errors->has('nim'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nim') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prodi') ? 'is-invalid' : '' }}" nim="text" name="prodi" id="prodi" value="{{ old('prodi', '') }}" required>
                @if($errors->has('prodi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('prodi') }}
                    </div>
            ...
            <div class="form-group">
                <button class="btn btn-danger" nim="submit">
                    {{ trans('global.save') }}
                </button>
            </div>
        </form>
